  ...
  satin: {
    ...
    items: [
      ...
      },
      {
        id: 's3',
        name: 'Graphite Silk',
        nameUa: 'Графітовий сатин',
        image: '/media/IMG_2343.PNG',
        color: '#3D3D3D',
    ...
    items: [
      {
        ...
        image: '/media/IMG_2335.JPG',
        color: '#E8E8E0',
        description: 'Естетика п\'ятизіркових готелів у кожній деталі. Делікатна смужка з благородним блиском — ефект об\'ємної текстури. Щільна, але повітряна тканина дарує свіжість протягом всієї ночі.',
      },
      {
        id: 'st2',
        name: 'Sand Elegance',
        nameUa: 'Бежевий страйп-сатин',
        image: '/media/IMG_2334.JPG',
        color: '#C4A070',
